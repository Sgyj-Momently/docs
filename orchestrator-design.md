...
아티팩트는 프로젝트 단위 디렉터리 아래에 단계별로 저장하는 방식을 권장한다.

- `.../<projectId>/bundles/bundle.json`
- `.../<projectId>/blog.md` *(선택)*
- `.../<projectId>/grouping/grouping-result.json`
- `.../<projectId>/hero-photo/hero.json`
- `.../<projectId>/outline/outline.json`
- `.../<projectId>/draft/draft.json`
- `.../<projectId>/style/styled.json`
- `.../<projectId>/review/final.json`

> 상세 규약은 `docs/contracts.md`를 단일 진실(source of truth)로 둔다.
